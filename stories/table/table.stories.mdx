...
<Canvas>
  <Story name="Placeholder" height="600px">
    {{
...
<Canvas>
  <Story name="Expand" height="600px">
    {{
...
<Canvas>
  <Story name="Sticky Header" height="600px">
    {{
...
<Canvas>
  <Story name="Sticky Columns" height="500px">
    {{
...
| enableScrollWrapper | boolean | -      | sticky columns 需要开启才会有左右侧虚线和阴影效果, 开启之后 table row 的 align-items 会变成 stretch，这里需要单独注意下 |
